...
export default function EcommerceZone() {
   ...
   * targetGender:
   * 电商专区自己的业务字段。
   * 这类字段不下沉到公共 hook，是因为它不是所有视频生成页面都通用的配置。
   */
   ...
   * 这里不依赖后端历史记录，是因为当前只是保留电商专区最近一次本地浏览上下文。
   */
  useEffect(() => {
   ...
   * 现在先传 VIDEO 类型，后面如果电商页要插入图片分析结果、文本建议，
    ...
    >
      ...
      <div style={{ maxWidth: 1440, margin: '0 auto' }}>
        ...
        >
          <GenerationTimeline
            ...
            emptyDescription="这里先作为电商专区的滚动展示区域"
      ...
      >
        <GenerationComposer
           ...
           * extraConfigContent:
           * 演示页面专属配置如何插入到公共输入区里。
           * 电商专区目前挂的是 gender，后面如果换成别的电商字段，还是复用这个插槽。
           */
          extraConfigContent={
            <Select
              value={targetGender}
